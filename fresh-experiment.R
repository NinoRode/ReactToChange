...
css_file <- file.path(getwd(), "www/custom-theme.css")
create_theme(
  theme = "spacelab",
  bs_vars_color(
    brand_primary = "#d1ab75",
...
ui <-shinyUI(
  fluidPage(
    ...
    actionButton("enter", "pr'tisn'", class = "btn-primary"),
    actionButton("danger", "pa tega, čes' upaš", class = "btn-danger"),
    actionButton("warn", "pazi, tega tut lahk' pr'tisneš", class = "btn-warning"),
    p("Mamica, tole pa dela.", class = "label label-success")
  )
)
